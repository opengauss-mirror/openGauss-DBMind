...
export const getListIndexAdvisorInterface = (data) => {
  return post(`/toolkit/advise/index?database=${data.database}&max_index_num=${data.max_index_num}&max_index_storage=${data.max_index_storage}&current=${data.current}&pagesize=${data.pagesize}`, data.textareaVal);
};
