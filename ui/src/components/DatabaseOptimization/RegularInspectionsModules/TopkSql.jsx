...
export default class TopkSql extends Component {
  static propTypes={
    topkSqlData:PropTypes.object.isRequired
  }
  constructor(props) {
    super(props)
    this.state = {
  ...
  UNSAFE_componentWillReceiveProps (nextProps) {
    this.handleTableData(nextProps.topkSqlData.header, nextProps.topkSqlData.rows)
  }
  render () {
