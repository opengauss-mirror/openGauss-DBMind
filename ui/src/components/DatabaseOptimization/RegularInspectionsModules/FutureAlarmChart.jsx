...
export default class FutureAlarmChart extends Component {
  static propTypes={
    futureAlarmChart:PropTypes.object.isRequired
  }
  constructor(props) {
    super(props)
    this.state = {
  ...
  UNSAFE_componentWillReceiveProps (nextProps) {
    this.handleTableData(nextProps.futureAlarmChart.header, nextProps.futureAlarmChart.rows)
  }
  render () {
