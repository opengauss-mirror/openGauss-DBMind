...
export default class FutureAlarm extends Component {
  static propTypes={
    futureAlarm:PropTypes.object.isRequired
  }
  constructor(props) {
    super(props)
    this.state = {
  ...
  UNSAFE_componentWillReceiveProps (nextProps) {
    this.handleTableData(nextProps.futureAlarm.header, nextProps.futureAlarm.rows)
  }
  render () {
