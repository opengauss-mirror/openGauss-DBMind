...
export default class HistoryAlarmChart extends Component {
  static propTypes={
    historyAlarmChart:PropTypes.object.isRequired
  }
  constructor(props) {
    super(props)
    this.state = {
  ...
  UNSAFE_componentWillReceiveProps (nextProps) {
    this.handleTableData(nextProps.historyAlarmChart.header, nextProps.historyAlarmChart.rows)
  }
  render () {
