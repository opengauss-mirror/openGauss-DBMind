...
export default class HistoryAlarm extends Component {
  static propTypes={
    historyAlarm:PropTypes.object.isRequired
  }
  constructor(props) {
    super(props)
    this.state = {
  ...
  UNSAFE_componentWillReceiveProps (nextProps) {
    this.handleTableData(nextProps.historyAlarm.header, nextProps.historyAlarm.rows)
  }
  render () {
    ...
    return (
      <div>
        <Card title="History Alarm" className="tps tableHeight  mb-20">
