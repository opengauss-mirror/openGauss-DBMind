...
|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| DBMind X86        | [dbmind-installer-x86_64-python3.10.sh.tar.gz](https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/dbmind/x86/dbmind-installer-x86_64-python3.10.sh.tar.gz)               | X86架构下DBMind安装包         |
| DBMind X86 SHA256 | [dbmind-installer-x86_64-python3.10.sh.tar.gz.sha256](https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/dbmind/x86/dbmind-installer-x86_64-python3.10.sh.tar.gz.sha256) | DBMind X86安装包SHA256校验文件 |
| DBMind ARM        | [dbmind-installer-aarch64-python3.10.sh.tar.gz](https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/dbmind/arm/dbmind-installer-aarch64-python3.10.sh.tar.gz)               | ARM架构下DBMind安装包         |
| DBMind ARM SHA256 | [dbmind-installer-aarch64-python3.10.sh.tar.gz.sha256](https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/dbmind/arm/dbmind-installer-aarch64-python3.10.sh.tar.gz.sha256) | DBMind ARM安装包SHA256校验文件 |
