...
@request_mapping('/v1/api/status/running', methods=['GET'], api=True)
...
@request_mapping('/v1/api/status/transaction', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_xact_status():
...
@request_mapping('/v1/api/status/node', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_node_status():
...
@request_mapping('/v1/api/status/instance', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/cluster', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/list/metric', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_all_metrics():
...
@request_mapping('/v1/api/sequence/{name}', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/metrics/{name}', methods=['GET', 'DELETE'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/alarm/history', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_history_alarms(pagesize: int = 20, current: int = 0,
                       ...
                       start_at: int = None, end_at: int = None, group: bool = False):
    return data_transformer.get_history_alarms(pagesize=pagesize, current=current, instance=instance,
                                               alarm_type=alarm_type, metric_name=metric_name,
                                               alarm_level=alarm_level, start_at=start_at, end_at=end_at, group=group)


@request_mapping('/v1/api/alarm/history_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_history_alarms_count(instance: str = None, alarm_type: str = None, alarm_level: str = None,
                             ...
                             group: bool = False):
    return data_transformer.get_history_alarms_count(instance=instance, alarm_type=alarm_type, alarm_level=alarm_level,
                                                     metric_name=metric_name,
                                                     start_at=start_at, end_at=end_at, group=group)


@request_mapping('/v1/api/workload_forecasting/sequence/forecast/{name}', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/alarm/future', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/alarm/future_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/alarm/healing', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/alarm/healing_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/slow/recent', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/slow/killed', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/slow/killed_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/top', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_top_queries():
...
@request_mapping('/v1/api/query/active', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/locking', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/list/database', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_db_list():
...
@request_mapping('/v1/api/list/users', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_users():
    username, password = oauth2.credential
...
@request_mapping('/v1/api/summary/index_advisor', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_existing_indexes', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/existing_indexes_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_advised_indexes', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_positive_sql', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/positive_sql_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/knob_tuning', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_knob_recommendation_snapshot', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/knob_recommendation_snapshot_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_knob_recommendation_warnings', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/knob_recommendation_warnings_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/get_knob_recommendation', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/knob_recommendation_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/slow_query', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/query/slow/recent_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/slow_query/projection', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/security', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/log', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/default_values', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_config_values(configname: str):
    config_dict = dict()
...
@request_mapping('/v1/api/toolkit/advise/query', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/setting/update_dynamic_config', methods=['POST', 'GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/toolkit/predict/query', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/setting/set', methods=['POST', 'GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/setting/get', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/setting/list', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def list_setting():
...
@request_mapping('/v1/api/summary/regular_inspections', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
# Backward-compatible alias for frontend/tests using hyphenated path
@request_mapping('/v1/api/summary/regular-inspection', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def get_regular_inspections_alias(inspection_type: str = None):
    return data_transformer.get_regular_inspections(inspection_type)


@request_mapping('/v1/api/summary/regular_inspections_count', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/real-time-inspection/exec', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def exec_real_time_inspections(inspection_type: str = None, start_time: str = None, end_time: str = None,
                               select_metrics: str = None):
    return data_transformer.exec_real_time_inspections(inspection_type, start_time, end_time, select_metrics)


@request_mapping('/v1/api/summary/real-time-inspection/list', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/real-time-inspection/report', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/real-time-inspection/delete', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/summary/correlation_result', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/toolkit/memory_check', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/app/timed-task/status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/toolkit/risk-analysis/{metric}', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/collection/status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/defaults', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/{name}/addition', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/{name}/deletion', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/{name}/pause', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/{name}/resumption', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/{name}/view', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/reconstruction', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/anomaly_detection/detectors/clearance', methods=['POST'], api=True)
@oauth2.token_authentication()
@standardized_api_output
def clear_detector():
...
@request_mapping('/v1/api/data-directory/status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/overview', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/instance/status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/agent/status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/app/kill/{pid}', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/app/query/wait_status', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
@request_mapping('/v1/api/app/query/wait_tree', methods=['GET'], api=True)
@oauth2.token_authentication()
@standardized_api_output
...
# @oauth2.token_authentication()  # Temporarily disabled for testing
@ParameterChecker.define_rules(
