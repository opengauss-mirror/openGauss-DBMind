...
class SlowQuery:
    def __init__(self, query, db_host=None, db_port=None, db_name=None, schema_name='public', start_timestamp=0,
                 ...
                 template_id=0, sort_count=0, sort_mem_used=0, sort_spill_count=1, hash_count=0, plan_time=0,
                 ...
                 n_tuples_updated=0, n_tuples_deleted=0, user_name=None, query_plan=None, query_id=-1, n_soft_parse=0,
