...
class MetaDataSupport:
    def __init__(self, dbname):
        self.db, self.cursor = workload_generation.BartSqlGen.FSM.base_setting.connect_server(dbname)
        self.dbname = dbname
        self.schema = workload_generation.BartSqlGen.FSM.base_setting.get_table_structure(dbname)
        # print(self.schema)
    ...
    def load_statistics(self, refresh=False):
        ...
        stat_path = os.path.abspath('.') + '/workload_generation/BartSqlGen/FSM/sampled_data/' + self.dbname + '/statistics'
    ...
    def get_data(self, refresh=False):
        sample_path = os.path.abspath('.') + '/workload_generation/BartSqlGen/FSM/sampled_data/' + self.dbname
