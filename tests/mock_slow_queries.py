...
simple_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
...
simple_slow_query_seq = Sequence(timestamps=[1640139695000],
                                 values=[101],
                                 name='pg_sql_statement_history_exec_time',
                                 step=5,
                                 labels=simple_slow_query_dict)

complex_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
...
complex_slow_query_seq = Sequence(timestamps=[1640139695000],
                                  values=[101],
                                  name='pg_sql_statement_history_exec_time',
                                  step=5,
                                  labels=complex_slow_query_dict)

commit_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
                          ...
                          'n_returned_rows': '1', 'n_tuples_returned': '100000', 'n_tuples_fetched': '0',
                          'n_tuples_inserted': '0', 'n_tuples_updated': '0', 'n_tuples_deleted': 0}
commit_slow_query_seq = Sequence(timestamps=[1640139695000],
                                 values=[101],
                                 name='pg_sql_statement_history_exec_time',
                                 step=5,
                                 labels=commit_slow_query_dict)

system_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
                          ...
                          'n_returned_rows': '1', 'n_tuples_returned': '100000', 'n_tuples_fetched': '0',
                          'n_tuples_inserted': '0', 'n_tuples_updated': '0', 'n_tuples_deleted': 0}
system_slow_query_seq = Sequence(timestamps=[1640139695000],
                                 values=[101],
                                 name='pg_sql_statement_history_exec_time',
                                 step=5,
                                 labels=system_slow_query_dict)

shield_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
                          ...
                          'n_returned_rows': '1', 'n_tuples_returned': '100000', 'n_tuples_fetched': '0',
                          'n_tuples_inserted': '0', 'n_tuples_updated': '0', 'n_tuples_deleted': 0}
shield_slow_query_seq = Sequence(timestamps=[1640139695000],
                                 values=[101],
                                 name='pg_sql_statement_history_exec_time',
                                 step=5,
                                 labels=shield_slow_query_dict)

locked_slow_query_dict = {'from_instance': '127.0.0.1:5432', 'datname': 'database1', 'schema': 'public',
                          'query': 'CREATE TABLE table1(id int, name varchar(10))', 'start_time': '1640149690000',
                          'finish_time': '1640139700000', 'hit_rate': '0.988', 'fetch_rate': '0.99', 'cpu_time': '14200',
                          'data_io_time': '1231243', 'unique_query_id': '12432453234', 'sort_count': '13',
                          'sort_mem_used': '12.43', 'sort_spill_count': '3', 'hash_count': '0', 'hash_mem_used': '0',
