...
from lineitem
where l_shipdate <= date '1998-12-01' - interval '68' day
...
from orders
where o_orderdate >= date '1995-08-01'
...
from (select n1.n_name                          as supp_nation,
      ...
      where s_suppkey = l_suppkey
        ...
        and ((n1.n_name = 'UNITED STATES' and n2.n_name = 'BRAZIL') or
...
from (select n_name                                                          as nation,
      ...
      where s_suppkey = l_suppkey
        ...
        and o_orderkey = l_orderkey
        and s_nationkey = n_nationkey
        and p_name like '%floral%') as profit
...
from (select c_custkey, count(o_orderkey)
      from customer
               left outer join orders on c_custkey = o_custkey and o_comment not like '%unusual%deposits%'
...
where p_partkey = ps_partkey
  ...
  and p_size in (23, 31, 4, 38, 37, 17, 3, 8)
...
from lineitem,
     part
where (p_partkey = l_partkey and p_brand = 'Brand#33' and p_container in ('SM CASE', 'SM BOX', 'SM PACK', 'SM PKG') and
       l_quantity >= 8 and l_quantity <= 8 + 10 and p_size between 1 and 5 and l_shipmode in ('AIR', 'AIR REG') and
       l_shipinstruct = 'DELIVER IN PERSON')
   or (p_partkey = l_partkey and p_brand = 'Brand#14' and
   ...
   or (p_partkey = l_partkey and p_brand = 'Brand#42' and p_container in ('LG CASE', 'LG BOX', 'LG PACK', 'LG PKG') and
       l_quantity >= 30 and l_quantity <= 30 + 10 and p_size between 1 and 15 and l_shipmode in ('AIR', 'AIR REG') and
       l_shipinstruct = 'DELIVER IN PERSON')
LIMIT 1;
...
where s_suppkey in (select ps_suppkey
                    ...
                    where agg_partkey = ps_partkey
                      ...
                      and ps_partkey in (select p_partkey from part where p_name like 'moccasin%')
...
from (select substring(c_phone from 1 for 2) as cntrycode, c_acctbal
      from customer
      where substring(c_phone from 1 for 2) in ('28', '27', '17', '10', '14', '34', '15')
        and c_acctbal > (select avg(c_acctbal)
                         from customer
                         where c_acctbal > 0.00
                           and substring(c_phone from 1 for 2) in ('28', '27', '17', '10', '14', '34', '15'))
